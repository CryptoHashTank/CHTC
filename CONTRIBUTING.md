Contributing to CHTC Core
============================

The CHTC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CHTC Core project, and is not to be
confused with overall CHTC Network Protocol consensus changes.

Whether a pull request is merged into CHTC Core rests with the project merge
...
Patches that change CHTC consensus rules are considerably more involved than
...
Where a patch set proposes to change the CHTC consensus, it must have been
...
The project leader is the release manager for each CHTC Core release.
