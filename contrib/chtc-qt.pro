...
RESOURCES += src/qt/chtc.qrc src/qt/chtc_locale.qrc

TRANSLATIONS += src/qt/locale/chtc_bg.ts \
                src/qt/locale/chtc_de.ts \
                src/qt/locale/chtc_en.ts \
                src/qt/locale/chtc_es.ts \
                src/qt/locale/chtc_fi.ts \
                src/qt/locale/chtc_fr.ts \
                src/qt/locale/chtc_it.ts \
                src/qt/locale/chtc_ja.ts \
                src/qt/locale/chtc_pl.ts \
                src/qt/locale/chtc_pt.ts \
                src/qt/locale/chtc_ru.ts \
                src/qt/locale/chtc_sk.ts \
                src/qt/locale/chtc_sv.ts \
                src/qt/locale/chtc_vi.ts \
                src/qt/locale/chtc_zh_CN.ts \
                src/qt/locale/chtc_zh_TW.ts
