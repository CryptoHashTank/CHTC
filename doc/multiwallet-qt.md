...
In order to support loading of multiple wallets in chtc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is chtc.cpp.
...
Changes to chtc.cpp
----------------------
chtc.cpp is the entry point into chtc-qt, and as such, will require some minor modifications to provide hooks for
