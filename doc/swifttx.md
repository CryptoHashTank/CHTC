...
This mechanism has been integrated into Bitcore-Node-CHTC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CryptoHashTank/insight-api-chtc#web-socket-api](https://github.com/CryptoHashTank/insight-api-chtc#web-socket-api) 
* API: [https://github.com/CryptoHashTank/insight-api-chtc#swifttx-transactions](https://github.com/CryptoHashTank/insight-api-chtc#swifttx-transactions) 
...
By default, the CHTC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CHTC Core daemon:
