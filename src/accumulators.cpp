...
bool ValidateAccumulatorCheckpoint(const CBlock& block, CBlockIndex* pindex, AccumulatorMap& mapAccumulators)
{
    ...
    //It is VERY IMPORTANT that when this is being run and height < v2_start, then zCHTC need to be disabled at the same time!!
...
std::list<CBlockIndex*> calculateAccumulatedBlocksFor(
    ...
    while (pindex) {
        ...
        // 10 blocks were accumulated twice when zCHTC v2 was activated
