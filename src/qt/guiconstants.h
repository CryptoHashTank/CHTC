...
/* Chtc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CHTC"
#define QAPP_ORG_DOMAIN "chtc.org"
#define QAPP_APP_NAME_DEFAULT "CHTC-Qt"
#define QAPP_APP_NAME_TESTNET "CHTC-Qt-testnet"
