                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCHTCPathCustom = GetArg("-zchtcbackuppath", "");
    ...
    if(!strzCHTCPathCustom.empty()) {
        ui->wallet_customzchtcbackuppath->setText(QString::fromStdString(strzCHTCPathCustom));
        ui->wallet_customzchtcbackuppath_label->setVisible(true);
        ui->wallet_customzchtcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCHTCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CHTC RPC console.") + "<br>" +
