...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CHTC features */
        {"chtc", "masternode", &masternode, true, true, false},
        {"chtc", "listmasternodes", &listmasternodes, true, true, false},
        {"chtc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"chtc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"chtc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"chtc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"chtc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"chtc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"chtc", "masternodedebug", &masternodedebug, true, true, false},
        {"chtc", "startmasternode", &startmasternode, true, true, false},
        {"chtc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"chtc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"chtc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"chtc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"chtc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"chtc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"chtc", "mnbudget", &mnbudget, true, true, false},
        {"chtc", "preparebudget", &preparebudget, true, true, false},
        {"chtc", "submitbudget", &submitbudget, true, true, false},
        {"chtc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"chtc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"chtc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"chtc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"chtc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"chtc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"chtc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"chtc", "checkbudgets", &checkbudgets, true, true, false},
        {"chtc", "mnsync", &mnsync, true, true, false},
        {"chtc", "spork", &spork, true, true, false},
        {"chtc", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzchtcseed", &getzchtcseed, false, false, true},
        {"zerocoin", "setzchtcseed", &setzchtcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzchtc", &searchdzchtc, false, false, true},
        {"zerocoin", "dzchtcstate", &dzchtcstate, false, false, true},
...
{
    return "> chtc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12261/\n";
}
