...
extern UniValue setzchtcseed(const UniValue& params, bool fHelp);
extern UniValue getzchtcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzchtc(const UniValue& params, bool fHelp);
extern UniValue dzchtcstate(const UniValue& params, bool fHelp);
