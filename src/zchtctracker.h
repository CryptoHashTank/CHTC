...
#ifndef CHTC_ZCHTCTRACKER_H
#define CHTC_ZCHTCTRACKER_H
...
public:
    CzCHTCTracker(std::string strWalletFile);
    ~CzCHTCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCHTCWallet* zCHTCWallet = NULL);
