...
#ifndef CHTC_ZCHTCWALLET_H
#define CHTC_ZCHTCWALLET_H
...
public:
    CzCHTCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCHTC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCHTC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
