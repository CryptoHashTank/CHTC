...
from fake_stake.base_test import CHTC_FakeStakeTest

class zCHTCwrappedSerialsTest(CHTC_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCHTCs..." % DENOM_TO_USE)
